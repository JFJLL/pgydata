...
const kolBundle = readFileSync("assets/1.3.0/assets/index-B09sHfUO.js", "utf8");
...
const signInBundle = readFileSync("assets/1.3.0/assets/index-B09sHfUO.js", "utf8");
const signInCss = readFileSync("assets/1.3.0/assets/index-kuUVLowI.css", "utf8");
...
assert.doesNotMatch(frontendBundleSources, legacyFrontendBrandPattern, "1.3.0 frontend bundle must not contain legacy brand residue");
