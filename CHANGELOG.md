...
- 修复：普通采集在创建采集窗口前由主进程按有效链接数量原子扣减树苗积分；余额不足时任务不会启动，并提示当前余额、本次需要数量和差额。
- 修复：暂停中的任务已在启动前完成积分扣减，不能再通过暂停后下载绕过积分消耗。
...
- Windows 安装包：
  ...
  - SHA256：`A04523F870E227A39A7D4EAC13ACFF0FB05B362640FBF7F7826348C9E20F8685`
- 前端资源包：
  - 路径：`D:\download\pic-vec\pgydata\desktop-versions\windows\1.1.3\magiorix-desktop-1.1.3-assets.zip`
  - SHA256：`9E87943E8EE44219FBA88C9494AD9DEE8819F8727A911E106A216BEA39880834`
