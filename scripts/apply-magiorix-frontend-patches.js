...
if (!fs.readFileSync(mainBundle, "utf8").includes("function PgyKolSearchPage")) {
  replaceOnce(
    mainBundle,
    "V1=new Map;function si(e){",
    "V1=new Map;" + pgyKolSearchPageSource.replace(/\n/g, "\r\n") + "\r\nfunction si(e){",
    "inject pgy-kol search page component after the lazy route table",
  );
}
