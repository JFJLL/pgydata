...
function pgyKolStatusText(s){if(s==="running")return "采集中";if(s==="paused")return "已暂停";if(s==="auth-expired")return "登录已失效";if(s==="risk-control")return "触发风控";if(s==="cancelled")return "已取消";if(s==="failed")return "采集失败";if(s==="completed")return "已完成";return s||"未知状态"}
